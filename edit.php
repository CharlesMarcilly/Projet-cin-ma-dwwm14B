...
session_start();
    ...
    // Si l'id du film à modifer n'est pas présent, ou n'existe pas dans le 'tableau' $_GET
    ...
    // Récupérer l'identifiant du film tout en protegant le système contre les failles de type XSS 
    $film_id = (int) htmlspecialchars(trim($_GET['film_id']));
    // $film_id_converted = intval($film_id);

    // Etablie une connexion avec la base de donnée
    ...
    // Dans le cas contraire,
    // Récuperons les informations du film à modifier
